...
%   youBot_Gazebo_insertRay_Viele.m
% --------------------------------------------------------
...
% load(filePath);
scan=load('GazeboScansyouBot_Walls.mat');
...
referenceScan = lidarScan(scan.LaserScans{180});
currentScan = lidarScan(scan.LaserScans{182});
% maxrange of laser
maxrange=5.6;
