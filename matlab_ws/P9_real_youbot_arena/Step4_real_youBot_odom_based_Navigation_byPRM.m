% Step4_real_youBot_Navigation_byPRM.m
%---------------------------------------------------------------
% starten des zugehoerigen Launch-Skriptes: 
% roslaunch ???
% .d.h. youBot in der Arena des Robotik-Labors

%% Achtung: Probleme mit der Odometrie beim realen youBot
%  unbedingt die pose Estimation mit AMCL durchführen
%  Initial Pose ggf. mit ginput()
% Workaround, den youBot auf Odom 0,0,0 stellen 
%--------------------------------------------------------------
% 16.06.2020
%---------------------------------------------------------------
%% -- ROS Init --
...
%% ---- Karte laden ----
goalRadius = 0.5;
mapInflated = load('realArenaMap.mat');
% Aufblasen (inflate) der Map
youBotRadiusGrid = 7; %Aufblasen auf youBot-Breite default 15
disp('Inflate Map ...');
