...
%% Initialize the matlab robot simulator
robotRadius = 0.4;
robot = ExampleHelperRobotSimulator('emptyMap',2);  % keine Karte
robot.enableLaser(false);                           % kein Laser
...
while( distanceToGoal > goalRadius )
    ...
    % Berechne gewünschte Bewegung [v, omega] aus der Pose x, y, theta
