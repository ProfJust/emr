...
echo -e "\033[34m ---------- EMR SS21 - youBot MELODIC Workspace einrichten  ------------ \033[0m "
...
#kein catkin-pkg  git clone https://github.com/ros-controls/ros_control.git -b melodic-devel
...
sudo apt-get install ros-melodic-joint-trajectory-action-tools -y
sudo apt-get install ros-melodic-rqt-joint-trajectory-controller -y
sudo apt-get install ros-melodic-ros-control -y
sudo apt-get install ros-melodic-astra-camera -y
sudo apt-get install ros-melodic-astra-launch -y
