...
echo -e "\033[34m ---------- EMR SS20 - ROS installieren und Workspace einrichten  ------------ \033[0m "
...
echo -e "\033[34m EMR - SS20 - catkin_ws is installed - now install youbot packages  \033[0m"
