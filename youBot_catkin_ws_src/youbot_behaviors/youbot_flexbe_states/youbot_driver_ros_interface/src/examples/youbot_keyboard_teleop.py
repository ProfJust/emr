#!/usr/bin/env python3
# Initial code created by Graylin Trevor Jay (tjay@cs.brown.edu) an published
# under Crative Commens Attribution license.
...
q/z,y : increase/decrease max speeds by 10%
